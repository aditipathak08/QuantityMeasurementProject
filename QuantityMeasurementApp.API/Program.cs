...
try 
{
    ...
    // To enable dependency injection (DI) so controllers can focus on coordination without knowing implementation details.
    // Scoped lifetime ensures a new instance is created for each HTTP request, matching database connection patterns.
